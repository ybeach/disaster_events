import { getCurrentInstance, inject, computed, defineComponent, provide, h, Suspense, Transition, reactive, useSSRContext, defineAsyncComponent, isRef, ref, resolveComponent, watchEffect, markRaw, watch, mergeProps, withCtx, createTextVNode, shallowRef, createApp, toRef, onErrorCaptured, unref, createVNode } from 'vue';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderComponent, ssrRenderSuspense } from 'vue/server-renderer';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const query = ref("");
    useRoute();
    props.ql == "" ? getCurrentKeyword() : props.ql;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-53370f98><form class="search-form" data-v-53370f98><input type="text"${ssrRenderAttr("value", query.value)}${ssrRenderAttr("placeholder", getPlaceHolder())} data-v-53370f98><button class="search-btn" type="submit" data-v-53370f98>\u691C\u7D22</button></form></div>`);
    };
  }
});
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-53370f98"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const lists = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="sr" data-v-e7bbaa61> \u30D2\u30C3\u30C8\uFF1A${ssrInterpolate(lists.total)} \u4EF6 `);
      if (__props.keyword.length > 0) {
        _push(`<span data-v-e7bbaa61>, \u30AD\u30FC\u30EF\u30FC\u30C9:${ssrInterpolate(__props.keyword)}</span>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
      if (lists.total > 0) {
        _push(`<div data-v-e7bbaa61><table data-v-e7bbaa61><tr data-v-e7bbaa61><th class="oneline" data-v-e7bbaa61>ID</th><th class="oneline" data-v-e7bbaa61>\u548C\u66A6</th><th class="oneline" data-v-e7bbaa61>\u30B0\u30EC\u30B4\u30EA\u30AA\u66A6</th><th class="oneline" data-v-e7bbaa61>\u5730\u57DF</th><th data-v-e7bbaa61>\u5929\u5909\u5730\u7570\u306A\u3069\u306E\u8A18\u4E8B</th><th data-v-e7bbaa61>\u539F\u51FA\u5178</th><th data-v-e7bbaa61>\u63B2\u8F09\u66F8\u8A8C</th></tr><!--[-->`);
        ssrRenderList(lists.lists, (list) => {
          _push(`<tr data-v-e7bbaa61><td class="oneline" data-v-e7bbaa61>${ssrInterpolate(list.id)}</td><td class="oneline" data-v-e7bbaa61>${ssrInterpolate(list.wareki)}</td><td class="oneline" data-v-e7bbaa61>${ssrInterpolate(list.gregorian)}</td><td class="oneline" data-v-e7bbaa61>${ssrInterpolate(list.area)}</td><td data-v-e7bbaa61>${ssrInterpolate(list.text)}</td><td data-v-e7bbaa61>${ssrInterpolate(list.source)}</td><td data-v-e7bbaa61>${ssrInterpolate(list.book)}</td></tr>`);
        });
        _push(`<!--]--></table></div>`);
      } else {
        _push(`<!---->`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-e7bbaa61"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  __name: "PaginationWithSearch",
  __ssrInlineRender: true,
  props: {
    numPages: Number,
    current: Number,
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "paging" }, _attrs))} data-v-def76157><div class="total" data-v-def76157>`);
      ...
      _push(` \u30DA\u30FC\u30B8 ${ssrInterpolate(__props.current)}/${ssrInterpolate(__props.numPages)} `);
      if (__props.current < __props.numPages) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: getPath(__props.current + 1)
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/PaginationWithSearch.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-def76157"]]);
const meta$1 = void 0;
const meta = void 0;
const _routes = [
  {
    name: "about",
    path: "/about",
    file: "/Users/yamada/git/disaster_events/src/pages/about.vue",
    children: [],
    meta: meta$2,
    alias: [],
    component: () => import('./_nuxt/about.73c9b001.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    file: "/Users/yamada/git/disaster_events/src/pages/index.vue",
    children: [],
    meta: meta$1,
    alias: [],
    component: () => import('./_nuxt/index.514c386a.mjs').then((m) => m.default || m)
  },
  {
    name: "usage",
    path: "/usage",
    file: "/Users/yamada/git/disaster_events/src/pages/usage.vue",
    children: [],
    meta,
    alias: [],
    component: () => import('./_nuxt/usage.54676b64.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component.9279b083.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
const layouts = {
  default: defineAsyncComponent(() => import('./_nuxt/default.61172b61.mjs').then((m) => m.default || m))
};
...
export { _export_sfc as _, useRoute as a, __nuxt_component_0$1 as b, __nuxt_component_1 as c, __nuxt_component_2 as d, entry$1 as default, __nuxt_component_0$2 as e, useHead as f, useNuxtApp as u };
